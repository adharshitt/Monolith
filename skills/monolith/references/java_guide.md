# Google JAVA Style Guide Details
...
avoids giving advice that isn't clearly enforceable (whether by human or tool).
 ...
 The term class is used inclusively to mean a normal class, record class, enum
...
anywhere in a source file. This implies that: 
 ...
 All other whitespace characters are escaped in char and string literals and in
 text blocks. 
...
previous lines. 
 ...
 Source file structure , and Section 3.3,
 Imports ). 
