# Google MARKDOWN Style Guide Details
...
to know more or didn’t find what they needed. 
 ...
 Use a [TOC] directive unless all
of your content is above the fold 1 on a laptop. 
...
glance. 
 ...
 Lists and subheadings sometimes suffice to present the same
...
﻿[tosche_station]: http://google3/power_converter.h
 ...
 Note that reference links are used to keep the table cells
manageable. 
